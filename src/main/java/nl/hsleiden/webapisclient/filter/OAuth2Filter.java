 ...
 */
package nl.hsleiden.webapisclient.filter;
...
public class OAuth2Filter implements Filter {
    ...
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
        ...
        if (debug) {
            log("OAuth2Filter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("OAuth2Filter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        // Validate wether an accesstoken already exists in the users session
        // if not, start Oauth flow
        if (wrappedRequest.getSession().getAttribute("accessToken") == null) {
            log("Er is geen accsstoken.");
            String clientId = filterConfig.getInitParameter("clientId");
            String clientSecret = filterConfig.getInitParameter("clientSecret");
            
            ClientIdentifier clientIdentifier = new ClientIdentifier(clientId, clientSecret);
            log("ClientIdentifier aangemaakt");
            ...
            holder.setFlow(flow);
            wrappedRequest.getSession().setAttribute("oAuthTokenHolder", holder);
            String authURI = flow.start();
            
            log(" Flow started. Returnvalue:  " + authURI);
            wrappedResponse.sendRedirect(authURI);
        }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("OAuth2Filter: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("OAuth2Filter(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("OAuth2Filter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("OAuth2Filter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("OAuth2Filter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("OAuth2Filter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("OAuth2Filter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
